...
//    }
    ...
    public static void main(String[] args) throws Exception {
        ...
        // Custom Notification: https://marxsoftware.blogspot.com/2008/02/publishing-user-objects-in-jmx.html
        // ........................

        // parsing arguments, possible values:
        // name=a1 https=8000 rmi=9999,9998
        ...
        if (args != null && args.length > 0) {
            for (String s : args) {
                ...
                if (s.length() > 5 && s.substring(0, 5).toLowerCase().equals("https=")) {
                    try {
                        int porta = Integer.parseInt(s.substring(5, s.length()));
                        if (porta > 0 && porta < 65000)
                            httpPort = porta;
                        else
                            System.out.println("Bad value of field \"https\"");
                    } catch (Exception e) {
                        System.out.println("Exception when parsing parameter \"https\"");
                    }
                }
