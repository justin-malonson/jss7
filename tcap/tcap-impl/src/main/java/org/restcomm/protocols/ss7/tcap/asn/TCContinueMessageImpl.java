...
public class TCContinueMessageImpl implements TCContinueMessage {
     ...
     * (non-Javadoc)
     *
     * @seeorg.restcomm.protocols.ss7.tcap.asn.comp.TCContinueMessage# getDestinationTransactionId()
     */
     ...
     * (non-Javadoc)
     *
     * @seeorg.restcomm.protocols.ss7.tcap.asn.comp.TCContinueMessage# getOriginatingTransactionId()
     */
     ...
     * (non-Javadoc)
     *
     * @seeorg.restcomm.protocols.ss7.tcap.asn.comp.TCContinueMessage# setOriginatingTransactionId(java.lang.String)
     */
